...
object ReadBookConfig {
    ...
    val configFilePath: String = FileUtils.getPath(appCtx.filesDir, configFileName)
    val shareConfigFilePath: String = FileUtils.getPath(appCtx.filesDir, shareConfigFileName)
    ...
    data class Config(
        ...
        var paddingTop: Int = 6,//正文边距
        var headerPaddingBottom: Int = 0,//页眉边距
        var headerPaddingLeft: Int = 16,
        var headerPaddingRight: Int = 16,
        var headerPaddingTop: Int = 0,
        var footerPaddingBottom: Int = 6,//页脚边距
        var footerPaddingLeft: Int = 16,
        var footerPaddingRight: Int = 16,
        var footerPaddingTop: Int = 6,
        var showHeaderLine: Boolean = false,//显示页眉分割线
        var showFooterLine: Boolean = true,//显示页脚分割线
